...
export const ConfirmQuantitiesFormTable = ({ details, token, supplierProps, defaultMovementStatus, isRequiredSelectSupplier = false, isRequiredQuantitySupplier, checkedProviders = false }: Props) => {
  ...
  type SupplierQuantity = { id?: string; tempId?: string; supplierId: string; deliveredQuantity: string };
  ...
  useEffect(() => {
    ...
    details.forEach((detail) => {
      initialData[detail.id] = detail.detailSuppliers.length === 0 && checkedProviders
        ? [{
          supplierId: '',
      ...
      initialDataShowSuppliers[detail.id] = detail.detailSuppliers.length > 0 && checkedProviders; // Si checkedProviders es true, no mostrar proveedores
                    ...
                    supplierDeliveredQuantities[item.id]?.map((entry, index) => {
                      ...
                      return (
                        <div key={uniqueId} className="flex items-center gap-2 mb-2">
                          ...
                          />
                          <Input
                            isRequired={isRequiredQuantitySupplier}
                          ...
                          <div className="min-w-52">
                            <SelectSearchSupplierAndCreate
                              ...
                              filterSuppliersByProductId={item.productId || undefined}
                              excludeSupplierIds={
