...
import { Add01Icon, Delete01Icon, PencilEdit01Icon, PlusSignIcon } from 'hugeicons-react';
...
export const UpdateProductFormModal = ({ categories, handlingUnits, branches, supplierProps, token }: Props) => {

    // Form
    const [productName, setProductName] = useState('');
    const [productDescription, setProductDescription] = useState('');
    const [productIsEnable, setProductIsEnable] = useState('');
