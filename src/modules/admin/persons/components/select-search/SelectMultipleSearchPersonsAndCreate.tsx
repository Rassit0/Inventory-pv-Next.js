...
interface Props {
    ...
    autoFocus?: boolean;
    create?: boolean;
    onPersonsSelectedChange?: (persons: IPerson[]) => void;
}
 ...
 */
export const SelectMultipleSearchPersonsAndCreate = ({ label, personsResponse, name, isRequired = false, setSelectedPerson, token, autoFocus = false, create = true, onPersonsSelectedChange }: Props) => {
    ...
    */
    ...
    useEffect(() => {
        if (onPersonsSelectedChange)
            onPersonsSelectedChange(filteredItems)
    }, [filteredItems])
    ...
    return (
        <div className='w-full flex items-start justify-center'>
            ...
            <Autocomplete
                ...
                isInvalid={isRequired && isInvalid && selectPersons.length <= 0 ? true : selectPersons.length > 0 ? false : undefined}
