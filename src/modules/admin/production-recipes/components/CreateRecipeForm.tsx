...
import { createRecipe } from '@/modules/admin/production-recipes';
...
export const CreateRecipeForm = ({ token, productsResponse }: Props) => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        // return;
        const { error, message, response } = await createRecipe({ token, formData });
        if (error) {
