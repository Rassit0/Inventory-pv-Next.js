...
import { IProductionDetailRecipe, IProductionDetailRecipeItem } from '@/modules/admin/production';
...
export const DetailsQuantityProductsRecipeOrderModal = ({ recipe, recipeCount }: Props) => {
